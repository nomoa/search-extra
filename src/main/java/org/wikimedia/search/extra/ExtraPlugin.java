...
public class ExtraPlugin extends Plugin implements SearchPlugin, AnalysisPlugin, ScriptPlugin {
    ...
    public List<QuerySpec<?>> getQueries() {
        return Arrays.asList(
            new QuerySpec<>(SourceRegexQueryBuilder.NAME_FIELD, SourceRegexQueryBuilder::new, SourceRegexQueryBuilder::fromXContent),
            new QuerySpec<>(FuzzyLikeThisQueryBuilder.NAME_FIELD, FuzzyLikeThisQueryBuilder::new, FuzzyLikeThisQueryBuilder::fromXContent)
        );
    }
    ...
    public List<ScoreFunctionSpec<?>> getScoreFunctions() {
        return Collections.singletonList(
            new ScoreFunctionSpec<LevenshteinDistanceScoreBuilder>(
                    LevenshteinDistanceScoreBuilder.NAME_FIELD,
